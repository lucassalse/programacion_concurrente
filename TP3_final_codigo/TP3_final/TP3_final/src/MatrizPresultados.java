...
public class MatrizPresultados {

	//private int[][] matriz = { {1,1,1,1,1} } ;
	
		private Lectura lectura;
		private int [][] matriz;
										
	public MatrizPresultados(int fila, int columna) {
		matriz = new int[fila][columna];
	}

	
	public MatrizPresultados(int[][] matriz) {
		this.matriz = matriz;
	}
	
	public MatrizPresultados(){
		lectura=new Lectura();
		matriz=lectura.leerMatriz(1,5,"/home/lucas/concurrentes_2019/codigoFuncionando_final/TP3_final/TP3_final/matrices/MatrizPresultados") ;
	}
